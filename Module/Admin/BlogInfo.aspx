...
<body style="margin-top: 0px; padding-top: 0px">
    ...
    <div>
        <table align="left" style="width: 226px" cellpadding="0" cellspacing="0">
            <tr>
                <td align="center" colspan="3" rowspan="2" style="height: 466px; background-image: url(../../Images/Skin/bg.jpg); width: 753px; background-repeat: no-repeat;">
                    <table style="width: 392px; vertical-align: top; border-top-width: thin; border-left-width: thin; border-left-color: black; border-bottom-width: thin; border-bottom-color: black; border-top-color: black; border-right-width: thin; border-right-color: black;">
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="font-size: 12pt; width: 36px; height: 21px; text-align: center">
                        ...
                        <tr style="font-size: 12pt">
                            ...
                            <td colspan="2" style="width: 36px; height: 21px; text-align: center">
                        ...
                        <tr style="font-size: 9pt; color: #000000">
                            <td style="width: 82px; height: 17px; text-align: center">
                                <span>修改密码:</span></td>
                            <td colspan="2" style="width: 36px; height: 17px; text-align: center">
                        ...
                        <tr style="font-size: 12pt; color: #000000">
                            ...
                            <td colspan="2" style="font-size: 12pt; width: 36px; height: 18px; text-align: center">
                                <asp:DropDownList ID="ddlSex" runat="server">
                                    <asp:ListItem>男</asp:ListItem>
                                    <asp:ListItem>女</asp:ListItem>
                                </asp:DropDownList>&nbsp;<span style="font-size: 9pt">&nbsp; &nbsp;生日:</span></td>
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="width: 36px; height: 21px; text-align: center">
                                <asp:TextBox ID="txtHphone" runat="server" Width="100px"></asp:TextBox>QQ:</td>
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="width: 36px; height: 21px; text-align: center">
                                <asp:TextBox ID="txtMphone" runat="server" Width="99px"></asp:TextBox>
                                ICQ:</td>
                            <td colspan="1" style="width: 173px; height: 21px" align="left">
